...
touch_detected3 = False  # Third touch sensor

# Function to continuously read from Arduino
def read_serial():
    global touch_detected, touch_detected2, touch_detected3
    ...
    while True:
        if ser.in_waiting > 0:
            ...
            if line == "1":
                ...
                touch_detected3 = True
            elif line == "4":
                touch_detected3 = False
...
def status():
    return jsonify({
        ...
        "touch_detected3": touch_detected3
    })
